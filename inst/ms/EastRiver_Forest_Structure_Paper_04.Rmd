...
Model results for explanatory variables were generally coherent between the two modeling strategies (Table 6). The five most influential variables on each response in GBM were also significant (p < 0.01) in GAM and exerted the most leverage on the responses based on interpretation of partial-effects plots.
