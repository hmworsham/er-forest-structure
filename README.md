...
|                                | itd_algorithms.csv                      | Comma-separated values file source data describing Layer Stackign ITD algorithm and parameters for Table A3                                                                                                                        |                                                                |                                                                     |                                                                                |                 |                                                                                                                                                                                                                                               |                   |     |     |
...
| inst/notebooks/tables_figures/ | fig1_domain.R                           | Reproduces manuscript Fig. 1                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig1.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig2_crownmap.R                         | Reproduces manuscript Fig. 2                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig2.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig3_itd_performance.R                  | Reproduces manuscript Fig. 3                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig3.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig4_height_distribution.R              | Reproduces manuscript Fig. 4                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig4.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig5_structure_metrics.R                | Reproduces manuscript Fig. 5                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig5.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig6_structure_histograms.R             | Reproduces manuscript Fig. 6                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig6.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig7_gbm.R                              | Reproduces manuscript Fig. 7                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig7.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig8_gam_partial_effects.R              | Reproduces manuscript Fig. 8                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig8.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig9_gam_interactions.R                 | Reproduces manuscript Fig. 9                                                                                                                                                                                                       | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig9.pdf                                                                       | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
|                                | fig10_geology.R                         | Reproduces manuscript Fig. 10                                                                                                                                                                                                      | sources archived data ESS-DIVE project repository from via wget |                                                                     | Fig10.pdf                                                                      | pdf             | pdf of manuscript figure                                                                                                                                                                                                                      | 1                 |     |     |
...
|                                | si_figs.R                               | Reproduces manuscript Supplementary Information figures                                                                                                                                                                            | sources archived data ESS-DIVE project repository from via wget |                                                                     | FigAX.pdf                                                                      | pdf             | pdfs of manuscript Supplementary Information figures                                                                                                                                                                                          | 3                 |     |     |
|                                | si_tables.R                             | Reproduces manuscript Supplementary Information tables                                                                                                                                                                             | sources archived data ESS-DIVE project repository from via wget |                                                                     | FigAX.svg                                                                      | svg             | svgs of manuscript Supplementary Information tables                                                                                                                                                                                           | 8                 |     |     |
|                                | table1.R                                | Reproduces manuscript Table 1                                                                                                                                                                                                      | sources archived data ESS-DIVE project repository from via wget |                                                                     | table1.svg                                                                     | svg             | svg of manuscript table                                                                                                                                                                                                                       | 1                 |     |     |
|                                | table2.R                                | Reproduces manuscript Table 2                                                                                                                                                                                                      | sources archived data ESS-DIVE project repository from via wget |                                                                     | table2.svg                                                                     | svg             | svg of manuscript table                                                                                                                                                                                                                       | 1                 |     |     |
|                                | table3.R                                | Reproduces manuscript Table 3                                                                                                                                                                                                      | sources archived data ESS-DIVE project repository from via wget |                                                                     | table3.svg                                                                     | svg             | svg of manuscript table                                                                                                                                                                                                                       | 1                 |     |     |
