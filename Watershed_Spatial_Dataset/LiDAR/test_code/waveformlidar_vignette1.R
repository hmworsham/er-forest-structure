...
#legend("bottom",legend=c("1","2","3"),col=c(3,4,5),lty=c(2,2,2),lwd=3,cex=2,box.lwd="white")
#legend("bottom",legend=c("SW","RW"),col=c("black","red"),lty=c(2,1),lwd=3,cex=2,box.lwd="white")
...
dr3<-apply(wf,1,decom.adaptive) ####to collect all data
